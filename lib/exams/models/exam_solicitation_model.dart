...
class ExamSolicitationModel {
  ...
  ExamSolicitationModel({@required this.examTypeModel, @required this.solicitationDate, @required this.id, @required this.status});

  static Map<String, dynamic> toMap(ExamSolicitationModel examSolicitationModel){
    return {
  ...
  static ExamSolicitationModel fromMap(Map examSolicitation, String examSolicitationId){
